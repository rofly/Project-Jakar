...
public class SlideShowFragment extends android.support.v4.app.DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        images = (ArrayList<Imagem>) getArguments().getSerializable("images");
    ...
    private void displayMetaInfo(int position) {
        ...
        lblTitle.setText(image.getSalaoNome());
        lblDate.setText(image.getSalaoId());
    }
