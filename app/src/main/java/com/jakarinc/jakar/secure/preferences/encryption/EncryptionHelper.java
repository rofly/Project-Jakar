package com.jakarinc.jakar.secure.preferences.encryption;
    ...
    public <T> T readAndDecodeTemplate(SharedPreferences prefs, String key, T defValue) {
        ...
        if (ois != null) {
            try {
                ...
                System.out.println("Error reading value by key: {}" + key + e);
            }
        }
        return result;
    }
    ...
    public <T> String encode(T value) {
        ...
        if (value != null) {
            try {
                ...
                System.out.println("Error encoding value" + e);
    ...
    private ObjectInputStream readDecoded(SharedPreferences prefs, String key) {
        ...
        if (stringValue != null) {
            try {
                ...
                System.out.println("Error reading from properties. Key: {}" + key + e);
                result = null;
            }
        } else {
            result = null;
