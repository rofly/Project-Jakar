package com.jakarinc.jakar.secure.preferences;

import android.annotation.TargetApi;
import android.content.SharedPreferences;
import android.os.Build;

import com.jakarinc.jakar.secure.preferences.encryption.EncryptionAlgorithm;
import com.jakarinc.jakar.secure.preferences.encryption.EncryptionHelper;
...
public class SecureSharedPreferences implements SharedPreferences {
     ...
     * @param encryption  The {@link edu.gmu.tec.scout.utilities.Encryption} to use.
     */
